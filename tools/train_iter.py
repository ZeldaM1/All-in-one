...
from mmedit.apis import init_random_seed, set_random_seed, train_model_iter
...
def parse_args():
    ...
    # parser.add_argument('--lambda_dur', type=list, default=[10,2048])
...
def main():
    ...
    # cfg.lambda_dur = args.lambda_dur
    ...
    if args.train_dataset is not None:
        cfg.data.train.dataset.gt_folder=args.train_dataset
    datasets = [build_dataset(cfg.data.train)]
    if args.test_dataset is not None:
        cfg.data.val.gt_folder=args.test_dataset
