...
def install_dependency():
    os.system('pwd')
    os.system('ls')
    # os.system('python -m pip install torch==1.9.1+cu111 torchvision==0.10.1+cu111 torchaudio==0.9.1 -f https://download.pytorch.org/whl/torch_stable.html  --user')
    ...
    os.system('python -m pip install pytorch_msssim timm scipy mmengine einops OmegaConf')
...
def upload_dataset(dataset_folder, dataset_name, is_video, unzip_file=True,sub_dir=None):
