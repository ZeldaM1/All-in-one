...
class EntropyCoder():
    def __init__(self, ec_thread=False, stream_part=1, isRans64=False):
        super().__init__()

        from .MLCodec_rans import RansEncoder, RansDecoder
        self.encoder = RansEncoder(ec_thread, stream_part, isRans64)
        self.decoder = RansDecoder(stream_part, isRans64)
    ...
    def encode_with_indexes_np(self, symbols, indexes, cdf, cdf_length, offset):
    ...
    def decode_stream_np(self, indexes, cdf, cdf_length, offset):
