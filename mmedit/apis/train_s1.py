...
from mmedit.core import DistEvalIterHook_s1, EvalIterHook_s1, build_optimizers
...
def _non_dist_train(model,
    ...
    if validate and cfg.get('evaluation', None) is not None:
        ...
        save_path = osp.join(cfg.work_dir, 'val_visuals')
        runner.register_hook(
            EvalIterHook_s1(data_loader, save_path=save_path, **cfg.evaluation),
            priority='LOW')
